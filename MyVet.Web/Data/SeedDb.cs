...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Carlos", "Araújo", "calaraujo@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Carlos", "A Araújo", "calaraujo@msn.com", "350 634 2747", "Calle Luna Calle Sol", "Customer");
        ...
        private async Task CheckServiceTypesAsync()
        {
            if (!_dataContext.ServiceTypes.Any())
            {
                ...
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Vacina" });
                await _dataContext.SaveChangesAsync();
            }
        }
